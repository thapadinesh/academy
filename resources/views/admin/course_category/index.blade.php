                                            ...
                                            <div class="card">
                                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                                    <div class="card-title">
                                                        <h3 class="card-label">Course Category</h3>
                                                    </div>
                                                        ...
                                                        <div class="dropdown dropdown-inline mr-2">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                                ...
                                                                <ul class="navi flex-column navi-hover py-2">
                                                                    ...
                                                                    <li class="navi-item">
                                                                    <a href="{{route('course_category.create')}}" class="navi-link">
                                                    ...
                                                    <table class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a name="" id="" class="btn btn-info btn-xs p-0 mr-1 float-left" href="{{route('course_category.edit',$category->id)}}" role="button"><i class="fa fa-edit p-2"></i></a>
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <form action="{{route('course_category.destroy',$category->id)}}" method="POST" enctype="multipart/form-data">
                                                                                            @method('delete')
                                                                                            @csrf
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @else
                                                                    <span class="label label-light-warning label-inline font-weight-bold">Inactive</span></td>
                                                                    @endif
                                                                <td>
                                                            </tr>
                                                            @endforeach
