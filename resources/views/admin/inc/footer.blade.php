					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">XDezo Technologies</a>
							</div>
							<!--end::Copyright-->
						</div>
						<!--end::Container-->
		...
		<script src="{{asset('assets/dist/assets/js/pages/widgets.js')}}"></script>
		<!--end::Page Scripts-->
		...
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{asset('assets/dist/assets/js/pages/crud/datatables/basic/scrollable.js')}}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
