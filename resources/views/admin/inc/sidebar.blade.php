						...
						<div class="aside-workspace scroll scroll-push my-2">
							...
							<div class="tab-content">
								...
								<div class="tab-pane p-3 px-lg-7 py-lg-5 fade show active" id="kt_aside_tab_1">
									...
									<!--end::Form-->
									<h3 class="p-2 p-lg-3 my-1 my-lg-3">XDezo Academy</h3>
									<!--begin::List-->
									<div class="list list-hover">
											...
											<div class="d-flex align-items-center">
                                                ...
                                                <a href="">
                                                    <div class="d-flex flex-column flex-grow-1 mr-2">
                                                        <span class="text-dark-75 font-size-h6 mb-0">Courses</span>
                                                    </div>
                                                </a>
												<!--begin::End-->
											</div>
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<!--begin::Text-->
												<div class="d-flex flex-column flex-grow-1 mr-2">
													<span class="text-dark-75 font-size-h6 mb-0">Events</span>
												</div>
												<!--begin::End-->
											</div>
										</div>
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<!--begin::Text-->
												<div class="d-flex flex-column flex-grow-1 mr-2">
													<span class="text-dark-75 font-size-h6 mb-0">Pages</span>
												</div>
												<!--begin::End-->
											</div>
										</div>
										...
										<div class="list-item hoverable p-2 p-lg-3 mb-2">
											<div class="d-flex align-items-center">
												...
												<!--begin::Text-->
												<div class="d-flex flex-column flex-grow-1 mr-2">
													<span class="text-dark-75 font-size-h6 mb-0">Contacts</span>
												</div>
												<!--begin::End-->
											</div>
										</div>
									...
									<div class="aside-menu-wrapper flex-column-fluid px-10 py-5" id="kt_aside_menu_wrapper">
										...
										<div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1">
											...
											<ul class="menu-nav">
												...
												<li class="menu-item" aria-haspopup="true">
													<a target="_blank" href="https://keenthemes.com/metronic/preview/demo3/builder.html" class="menu-link">
														<span class="svg-icon menu-icon">
															<!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
